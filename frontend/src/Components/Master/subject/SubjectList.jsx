  ...
  const handleDelete = (id) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        axios
          .delete(`http://localhost:5000/api/subject/${id}`)
          .then((response) => {
          ...
          .catch((error) => {
            ...
            Swal.fire("Error!", "There was an issue deleting the subject.", "error");
          });
      }
    });
  };
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="actionButtons d-flex gap-2">
          ...
          <Link to={`/subject/update/${row.id}`} type="button" className="">
            <FaRegEdit />
          </Link>
          <button
          type="button"
    ...
    <Mainlayout>
      <div className="container">
        <div className="d-flex justify-content-end align-items-center mb-3">
          ...
          <Link to={"/subject/create"} className="btn btn-primary">
            <FaPlus/>
          </Link>
        </div>
