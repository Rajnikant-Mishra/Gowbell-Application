...
//         {Array.from({ length: 159 }).map((_, index) =>
//           index % 2 === 0 ? (
//             <div
//               key={index}
//               style={{
...
export default function OMRSheet({
  ...
  return (
    ...
    >
      {/* Left Vertical Bars */}
      <div className={`${styles.bars}`}>
        {Array.from({ length: 172 }).map((_, index) =>
          index % 2 === 0 ? (
            <div
              key={index}
              style={{
      ...
      <div className="mt-0 d-flex flex-column" style={{ height: "100%" }}>
        {/* Header */}
        <div className={`mx-auto text-center ${styles.header}`}>
          <div className={styles.headerContainer}>
            <div className={styles.headerText}>
        ...
        <div style={{ fontSize: "0.8rem", marginTop: "-18px" }}>
          <div className={styles.formContainer}>
            <div className={styles.inputGroup} style={{ width: "185mm" }}>
              <div className={styles.labelContainer}>
                <label
                  htmlFor="student-name"
                  className={`${styles.label} fw-bold`}
            ...
            <div className={styles.inputGroup} style={{ width: "185mm" }}>
              ...
              <input
                ...
                className={`${styles.inputField1}`}
                type="text"
                //  value={`${schoolName ?? ""} ${address ?? ""}`.toUpperCase()}
                value={`${schoolName ?? ""}${address ? ` ,${address}` : ""}`.toUpperCase()}
                style={{
                  fontFamily: "Arial",
                  fontSize: "12px",
                  textTransform: "uppercase",
        ...
        <div className="row mb-2 flex-grow-1">
          <div className="col-3">
            <div className={styles.leftColumn}>
              <div
                className={`${styles.detailBox} ${styles.rolldiv}`}
                style={{ width: "40.5mm" }}
              >
                <div
                  className={`${styles.textBox3} textBox d-flex flex-column P-0`}
          ...
          <div className={`${styles.table2} col-3`}>
            <table className={`${styles.tablediv} `}>
              <thead className={`${styles.questiondiv}`}>
                <tr>
                  <th className="text-center text-white">Q.No.</th>
                  <th
