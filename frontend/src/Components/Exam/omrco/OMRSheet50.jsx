...
export default function OMRSheet({
  ...
  return (
    ...
    <div className="container">
      <img src={img} alt="omr" className="bg-image" />

      {/* Logo */}
      <img src={logo} alt="logo" className="logo" />

      {/* Text */}
      <span className="text name">{student.toUpperCase()}</span>
      <span className="text school">{schoolName.toUpperCase()}</span>
      <span className="text date">{examDate}</span>
      <span className="text level">{level}</span>
      <span className="text standard">{className}</span>
      <span className="text subject">{subject}</span>
