...
//     setExamDate(""); // Reset exam date when country changes
//     setStudents([]);
//     setTotalCount(0);
...
//     setSelectedClassId("");
//     setSelectedSubjectId("");
//     setExamDate(""); // Reset exam date when state changes
//     setStudents([]);
//     setTotalCount(0);
...
//     setSelectedClassId("");
//     setSelectedSubjectId("");
//     setExamDate(""); // Reset exam date when district changes
//     setStudents([]);
//     setTotalCount(0);
...
//         }
//         schoolCode="OR0829"
//         examDate={examDate} // Pass examDate instead of selectedExamDate
...
//                   !selectedClassId ||
//                   !selectedSubjectId ||
//                   !examDate || // Disable button if exam date is not selected
//                   isLoading ||
//                   totalCount === 0
//                 }
