...
//           <h2>SCIENCE OLYMPIAD FOUNDATION </h2>
...
//             OLYMPIAD
//           </h2>
//           <h2>ATTENDANCE-SHEET (2024-25)</h2>
//         </div>
...
//           <br />
//           <span className="font-bolder text-black">
//             Chosen Date of Exam: 28th November, 2024
//           </span>
//         </div>
//       </div>
...
//           SCHOOL CODE: <span className="schoolCode"> OR0829</span>
//         </span>
...
//               <span className="schoolName">GAYATRI SMART SCHOOL</span>
//               <span className="schoolAddress">
//                 SUDHASADANGI, PO-BRAHMANSUANLO PS-BALIANTA, BHUBANESWAR, ODISHA
//               </span>
//             </div>
//           </span>
//         </div>
...
//           CLASS: <span id="className">06</span>
//         </h2>
//       </div>
//       <table className={styles.table}>
//         <thead>
//           <tr style={{ borderBottom: "2px solid black", borderColor: "black" }}>
...
//         <h3>
//           1. Students registered from class 06; section wise breakup is as
//           follows:
//         </h3>
//         <div className={styles.sectionBreakup} style={{ width: "50%" }}>
//           <div className="text-center ">
//             <b
//               style={{ borderBottom: "2px solid black", borderColor: "black" }}
//             >
//               SRS SECTION
//             </b>
//             <br />
...
//             </b>
//             <br />
//             <b className="totalStudent">3</b>
//           </div>
//         </div>
//         <h3>
//           <ol start="2">
//             <li>
//               Please make Student’s Name correction, if any, in attendance
//               sheet. (IN BLOCK LETTERS)
//             </li>
//             <li>
//               Please ensure that all the corrections are incorporated &
//               attendance sheet despatched with Answer-Sheets.
//             </li>
//             <li>
