...
//         .map((id) => subjects.find((sub) => sub.value === id)?.label || "N/A")
//         .join(", "),
//       gold: highestPercentage,
//       silver: secondHighestPercentage,
//       bronze: thirdHighestPercentage,
...
//       `Result_${
//         schools.find((s) => s.id === selectedSchool)?.school_name || "School"
//       }_Classes${selectedClassIds.join("_")}_Subjects${subjectNames.replace(/, /g, "_")}.pdf`
//     );
...
//       const component = (
//         <MedalsWinnersList
//           medalsTally={subjectNames
//             .map((name) => ({
//               subject: name,
//               medals: [
//                 {
//                   medal: "Gold",
//                   quantity: winnersList.filter(
//                     (s) => s.subject === name && s.medal === "Gold"
//                   ).length,
//                 },
//                 {
//                   medal: "Silver",
//                   quantity: winnersList.filter(
//                     (s) => s.subject === name && s.medal === "Silver"
//                   ).length,
//                 },
//                 {
//                   medal: "Bronze",
//                   quantity: winnersList.filter(
//                     (s) => s.subject === name && s.medal === "Bronze"
//                   ).length,
//                 },
//               ],
//             }))
//             .flatMap((tally) => tally.medals)}
//           classCutoff={classCutoff}
//           winnersList={winnersList}
//           schoolName={
//             schools.find((s) => s.id === selectedSchool)?.school_name || "N/A"
...
//           district={districtName}
//           city={cityName}
//           singleSubject={subjectName} // Render only this subject
//         />
//       );
