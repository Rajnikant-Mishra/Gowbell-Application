...
// setSliderIndex(0); // Reset slider to first student
// };
...
//       <h3>Top 3 Students - Subject-wise Leaderboard</h3>
...
//                   index === sliderIndex ? styles.activeDot : ""
//                 }`}
...
//           </div>
//         </div>
//         {topStudents[sliderIndex] && (
//           <div className={styles.studentDetails}>
//             <h4>{topStudents[sliderIndex].name}</h4>
//             <p>
//               <strong>Roll Number:</strong>{" "}
//               {topStudents[sliderIndex].rollNumber}
//             </p>
//             <p>
//               <strong>School:</strong> {topStudents[sliderIndex].schoolName}
//             </p>
//             <p>
//               <strong>
...
//                 Score:
//               </strong>{" "}
//               {topStudents[sliderIndex][selectedSubject]}
//             </p>
//             <p>
...
//               {subjects
//                 .filter((s) => s.value !== selectedSubject)
//                 .map((s) => (
//                   <li key={s.value}>
//                     <span className="font-semibold">{s.label}</span>:{
// " "}
//                     {topStudents[sliderIndex][s.value]}
//                   </li>
//                 ))}
//             </ul>
//           </div>
...
// // import { UilCalenderAlt, UilUser, UilAngleDown  } from '@iconscout/react-unicons'; 
