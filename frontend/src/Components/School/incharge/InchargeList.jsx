...
export default function DataTable() {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:5000/api/get/incharges") // Your API URL here
      .then((response) => {
        ...
        >
          <thead>
            ...
            >
              ...
              {["school name", "incharge name", "incharge dob","class from","class to","mobile number",  ].map((col) => (
              ...
              >
                ...
                <td>
                  <div className={styles.actionButtons}>
                    ...
                    <Link to={`/incharge/update/${row.id}`}>
