...
export default function SchoolForm() {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      session_id: session_id || "", // Initialize with session_id from localStorage
    },
    ...
    onSubmit: async (values) => {
      try {
        ...
        // ADD THIS LINE HERE 👇
        values.principal_whatsapp = values.principal_whatsapp?.startsWith("91")
          ? values.principal_whatsapp
          : `91${values.principal_whatsapp}`;
