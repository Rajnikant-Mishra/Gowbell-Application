      ...
      if (result.isConfirmed) {
        ...
        axios
          ...
          .catch((error) => {
            ...
            Swal.fire("Error!", "There was an issue deleting the District.", "error");
          });
      }
    });
  };
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="actionButtons d-flex gap-2">
          ...
          <Link to={`/district/update/${row.id}`} type="button" className="">
            <FaRegEdit />
          </Link>
          <button
          type="button"
    ...
    <Mainlayout>
      <div className="container">
        <div className="d-flex justify-content-end align-items-center mb-3">
          ...
          <Link to={"/district/create"} className="btn btn-primary">
            <FaPlus/>
          </Link>
        </div>
