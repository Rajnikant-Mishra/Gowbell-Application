          ...
          exams.map(async (record) => {
            try {
              ...
              return {
                ...
                updated_at: formatTimestamp(record.updated_at),
                created_by: userName,
                classes: Array.isArray(record.classes) ? record.classes.join(", ") : "",
                subjects: Array.isArray(record.subjects) ? record.subjects.join(", ") : "",
              };
            } catch (userError) {
              console.error(
        ...
        axios
          ...
          .catch((error) => {
            ...
            Swal.fire({
              ...
              icon: "error",
              title: "Error!",
              text: "There was an issue deleting the exam.",
              showConfirmButton: false,
              timer: 2000,
              toast: true,
              background: "#fff",
