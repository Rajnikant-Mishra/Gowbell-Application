        ...
        <div>
          ...
          <div style={{ fontSize: "0.8rem" }}>
            <div className={styles.formContainer}>
              ...
              <div className={styles.inputGroup}>
                <div className={styles.labelContainer}>
                  <label htmlFor="school-name" className={styles.label}>
              ...
              <div className={styles.column}>
                <div className={styles.detailBox}>
                  <div
                    ...
                    className={`${styles.textBox} textBox d-flex flex-column`}
                  >
                    <label htmlFor="standard" className="text-center">
                      Standard
                    </label>
                    <p></p>
                  </div>
                ...
                <div className={styles.detailBox}>
                  ...
                  >
                    <ol className={styles.ruleBox}>
                      <li>
                        Write Your <b>Roll Number</b> on the left side of the
                        OMR sheet in the box specified and darken the
                        appropriate circles given by using{" "}
                ...
                <tbody>
                  {Array(20)
                    ...
                    .map((item, index) => (
                      <tr key={index}>
                        <td
                          className={`${styles.questionnumberdiv} text-center`}
                        >
                          {index + 1}
                        </td>
          ...
          <div className="row">
            ...
            <div className="col-6">
              ...
              >
                ...
                />
                <label htmlFor="invigilator-signature">
