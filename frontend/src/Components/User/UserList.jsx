...
//       setLoading(true);
//       try {
//         const response = await axios.get(`${API_BASE_URL}/api/u1/users`);
//         const formattedData = response.data.map((record) => ({
//           ...record,
//           created_at: formatTimestamp(record.created_at),
//           role_name: record.role_name || "Unknown Role",
//         }));
...
//             return (
//               <img
//                 src={`${API_BASE_URL}/profiles/${params.value}`} // <-- add full path
//                 alt="Profile"
//                 style={{
//                   width: "35px",
//                   height: "35px",
...
//           <Breadcrumb data={[{ name: "User" }]} />
//         </div>
//         <div>
//           <CreateButton link="/user" />
//         </div>
//       </div>
//       <div
//         style={{
...
export default function User() {
  ...
  // Required states for search + checkbox
      ...
      >
        ...
        {loading ? (
          <div style={{ textAlign: "center", padding: "100px 0" }}>
            ...
            <p style={{ marginTop: 20, color: "#555" }}>Loading users...</p>
          </div>
        ) : (
          <>
            <TableContainer
            ...
            >
              <Table stickyHeader sx={{ minWidth: 1000, border: "none" }}>
                <TableHead>
                  <TableRow>
                    <TableCell
                      padding="checkbox"
                    ...
                    currentPageRecords.map((row, index) => (
                      ...
                      >
                        ...
                        <TableCell align="center">
                          {row.user_profile ? (
                            <img
                              src={`${API_BASE_URL}/profiles/${row.user_profile}`}
                              alt="Profile"
                              style={{
                                width: "35px",
                                height: "35px",
            ...
            >
              ...
              <div style={{ color: "#555", fontSize: "14px" }}>
                {totalFiltered} records • Page {page} of{" "}
              ...
              >
                ...
                <button
                  ...
                  disabled={
                    page === totalFilteredPages || totalFilteredPages === 0
                  }
                  style={{
                    padding: "6px 10px",
                    borderRadius: "6px",
                    border: "1px solid #ccc",
                    background:
                      page === totalFilteredPages ? "#f0f0f0" : "#fff",
                    cursor:
                      page === totalFilteredPages ? "not-allowed" : "pointer",
                  }}
                >
                  <UilAngleRightB />
                </button>
