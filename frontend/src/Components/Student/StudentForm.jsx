  ...
  useEffect(() => {
    const fetchClasses = async () => {
      try {
        ...
        toast.error("Failed to fetch classesa classes.");
      }
    };
    fetchClasses();
  }, []);
...
//                     );
//                     formik.setFieldValue("school_name", selectedOption ? selectedOption.school_name : "");
//                     formik.setFieldValue("school_id", selectedOption ? selectedOption.school_id : "");
//                     setSelectedSchool(e.target.value);
//                   }}
//                   onBlur={formik.handleBlur}
//                   error={
