...
// // If you're using body-parser manually:
// app.use(bodyParser.json({ limit: "5000mb" }));
// app.use(bodyParser.urlencoded({ limit: "5000mb", extended: true }));

// // Allow large JSON and form-data payloads
// // 🔴 absolutely first body-parser setup
...
app.use(express.urlencoded({ extended: true, limit: "1000mb", parameterLimit: 500000 }));
