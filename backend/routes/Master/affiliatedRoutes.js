...
import { createAffiliated, getAllAffiliated, getAll , getAffiliatedById, updateAffiliated, deleteAffiliated } from '../../controllers/Master/affiliatedController.js';
import { authenticateToken  } from "../../middleware/verifyToken.js";
const router = express.Router();

router.post('/affiliated',authenticateToken , createAffiliated);
router.get('/affiliated', getAllAffiliated);
router.get('/affiliated-paginate', getAll);
