...
const ResultModel = {
  ...
  // getStudents: (schoolId, classIds, subjectIds, sessionId, level callback) => {
  ...
  //       // Step 3a: Update students with medals (Gold, Silver, Bronze)
  ...
  //     `;
  //       const updateStudentMedalParams = [schoolId, ...classIds, ...subjectIds];
