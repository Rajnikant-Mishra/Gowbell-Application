...
import {
  ...
  getFilteredStudentsByResult,
} from "../../models/Results/result.controller.js";
...
//email send from result schoools
router.post("/result-email", getFilteredStudentsByResult);
